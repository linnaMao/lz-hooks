...
// 节气
const getSolarTerm = (gy: number, gm: number, gd: number) => {
  const sTermInfo = [
    0,
    21208,
    42467,
...
const useCalender = () => {
  ...
  React.useEffect(() => {
    ...
    setCalender({
      ...
      // 节气
      solarTerm: getSolarTerm(GY, GM, GD),
    });
  }, []);
